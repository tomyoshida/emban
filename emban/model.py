...
import time
import numpyro
from numpyro.distributions import MultivariateNormal, Normal, Uniform,TruncatedNormal
...
class model:
    ...
    def __init__(self, incl, r_out, N_GP, userdef_vis_model = None, flux_uncert = False, jitter=1e-6):
        '''
            ...
            if self.flux_uncert:
                ...
                for _obs in obs:
                    ...
                    numpyro.sample(
                                ...
                                Normal(loc= f_band * _obs.V_model, scale= _obs.s ),
                                obs = _obs.V
                            )
